...
from beeline_issue_tracker.ui.theme import DARK_THEME, LIGHT_THEME, SYSTEM_THEME, ThemeManager
...
class SettingsPage(HoneycombBackground):
    ...
    def __init__(
        ...
        header.addWidget(BrandHeader("Settings", "Admin controls", paths.logo_path(), theme_manager), 1)
